...
"""
    ...
    def handle(self, message: str) -> ChatResponse:
        ...
        for tool_name in self._tool_sequence_from_message(message):
            ...
            if canonical_name in executed_tools:
                continue
            ...
            executed_tools.add(canonical_name)
    ...
    def _tool_sequence_from_message(self, message: str) -> list[str]:
        ...
        if dynamic_tool and self._canonical_tool_name(dynamic_tool) not in {self._canonical_tool_name(item) for item in ordered}:
    ...
    def _fallback_tool_args(self, message: str, tool_name: str) -> dict[str, Any]:
        ...
        normalized_tool = self._canonical_tool_name(tool_name)
